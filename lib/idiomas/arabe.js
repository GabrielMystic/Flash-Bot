...
const smsLista1 = () => { return `🌟 معلومات FLASHBOT 🌟`}
...
const smsLista7 = () => { return `⚡ تثبيت FLASHBOT ⚡`}
...
//_allantilink.js
const smsTextoYT = () => { return '⚡ ممتاز ꜱᴜᴘᴇʀ ꜰʟᴀꜱʜʙᴏᴛ - ᴡʜᴀᴛꜱᴀᴘᴘ '}
...
const smsModP2 = () => { return `تمكين الوظيفة حتى يتمكن الجميع من استخدام LightningBot`}
const smsModAd1 = () => { return `🛂 وضع المشرف`}
const smsModAd2 = () => { return `سيتمكن المسؤولون فقط من استخدام LightningBot في المجموعات`}
