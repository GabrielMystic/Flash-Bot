...
const smsLista1 = () => { return `🌟 FLASHBOT INFORMATION 🌟`}
...
const smsLista7 = () => { return `⚡ INSTALL FLASHBOT ⚡`}
...
const smsModP2 = () => { return `Enable function so everyone can use LightBot`}
const smsModAd1 = () => { return `🛂 ADMIN MODE`}
const smsModAd2 = () => { return `Only Admins will be able to use LightBot in Groups`}
