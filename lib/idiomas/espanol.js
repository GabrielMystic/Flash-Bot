...
const smsLista1 = () => { return `⚡ INFORMACIÓN DE FLASHBOT ⚡`}
...
const smsLista7 = () => { return `⚡ INSTALAR FLASHBOT ⚡`}
...
//_allantilink.js
const smsTextoYT = () => { return '⚡ 𝗦𝘂𝗽𝗲𝗿 𝗙𝗹𝗮𝘀𝗵-𝗕𝗼𝘁 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 '} //🟡 NO CAMBIAR 
...
const eFlashTickets = () => { return '🎫 Flash Tickets' } 
...
const smsModP2 = () => { return `Habilitar función para que todos puedan usar FlashBot`}
const smsModAd1 = () => { return `🛂 MODO ADMIN`}
const smsModAd2 = () => { return `Solo los Admins podrán usar FlashBot en Grupos`}
