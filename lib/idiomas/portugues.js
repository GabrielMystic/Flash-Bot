...
const smsLista1 = () => { return `⚡ INFORMAÇÕES DO FLASHBOT ⚡`}
...
const smsLista7 = () => { return `⚡ INSTALAR O FLASHBOT ⚡`}
...
//_allantilink.js
const smsTextoYT = () => { return '⚡ ꜱᴜᴘᴇʀ ꜰʟᴀꜱʜʙᴏᴛ - ᴡʜᴀᴛꜱᴀᴘᴘ '}
...
const eFlashTickets = () => { return '🎫 Flash Tickers' } 
...
const smsModP2 = () => { return `Ativar função para que todos possam usar o LightningBot`}
const smsModAd1 = () => { return `🛂 MODO ADMINISTRADOR`}
const smsModAd2 = () => { return `Apenas Admins poderão usar o LightningBot em Grupos`}
