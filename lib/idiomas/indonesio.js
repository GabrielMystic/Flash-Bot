...
const smsLista1 = () => { return `🌟 INFORMASI FLASHBOT 🌟`}
...
const smsLista7 = () => { return `⚡ PASANG FLASHBOT ⚡`}
...
//_allantilink.js
const smsTextoYT = () => { return ' Super Lightning-Bot - WhatsApp '}
...
const smsModP2 = () => { return `Aktifkan fungsi agar semua orang dapat menggunakan LightningBot`}
const smsModAd1 = () => { return `🛂 MODE ADMIN`}
const smsModAd2 = () => { return `Hanya Admin yang dapat menggunakan LightningBot di Grup`}
